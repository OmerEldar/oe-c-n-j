...
from file_handler import FileHandler, FileError
...
def test_read_nonexistent_file():
    ...
    with pytest.raises(FileError) as exc:
        FileHandler.read_json_file("nonexistent.json")
...
def test_read_invalid_json(test_file_path, cleanup_file):
    ...
    with pytest.raises(FileError) as exc:
        FileHandler.read_json_file(test_file_path)
...
def test_read_permission_error(cleanup_file):
    ...
    with pytest.raises(FileError) as exc:
        FileHandler.read_json_file(test_file)
...
def test_read_success_no_mock(cleanup_file):
    ...
    result = FileHandler.read_json_file(test_file)
...
def test_read_success_with_mock():
    ...
    with patch('builtins.open', mock_open(read_data=mock_json_data)):
        result = FileHandler.read_json_file("fake_path.json")
